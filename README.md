...
자유 베이스에서 빈 컵을 집고, 바퀴 속도 제어로 손님 테이블까지 이동해 컵을 내려놓는다.
...
`water-service` 모드에서 물붓기·병 복귀까지 이어졌으나 중앙 적재 때 왼팔 자체 충돌로 중단됐다.
정지 자세 대조 시험에서도 후보 자세의 겹침을 확인했다. 중앙 적재·재파지·전체 서빙은 미완료다.
충전소 복귀도 남아 있다.
