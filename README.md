...
실물 재개는 보류하고 [발표용 식당 환경](docs/20260921_식당_시뮬레이션_환경.md)을 추가했다.
주방·손님 테이블·충전 구역의 USD와 주행 지도를 생성한다. 정적 A* 경로 검사와 실제
Nav2·Behavior Tree 실행은 구분하며, 이동 베이스와 전체 서빙 통합은 아직 남아 있다.
