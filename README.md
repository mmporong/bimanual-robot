...
**실험실에서 사람이 하던 시료 용기 취급 작업을, 양팔 로봇이 시연 학습으로 수행하는 데스크톱 작업 셀.** 원본은 ABB YuMi 기반 실험실 워크스테이션이고, 그중 용기 개폐와 내용물 이송을 테이블탑 규모로 축소한다.

포트폴리오의 주어는 태스크가 아니라 **수집·판정·학습·평가 파이프라인과 실패 진단·개선 루프**다. 태스크는 그 검증 사례다. 상세: [docs/20260820_프로젝트_정의.md](docs/20260820_프로젝트_정의.md)
