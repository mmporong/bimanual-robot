...
- 시뮬레이터: Isaac Sim 6.0 목표 계약 · 로컬 5.1 URDF 프리뷰(ROS Bridge 미사용)
...
아직 베이스 고정·중력/물리 접촉 제외 상태이며 닫기·들어올림은 미검증이다. 구형 원본의 바퀴 320 mm·
...
9월 21일 병 접근·파지·상승·복귀 계획과 물리 시험 실행기를 추가했으나, 병 파지는 아직 실패 상태다.
가정한 35 g 병에 접근하는 동안 죠보다 손목 쪽 링크가 먼저 닿았다. 기존 SO101 부품과 ggao의
실제 결합 위치를 대조해야 하며, 충돌 형상을 삭제해서 통과시키지는 않았다.
같은 코드의 왼손 5 g 컵·위치 오차 −5 mm 시험은 재접근 1회 후 내려놓기까지 통과했다.
[오른손 병 실험·현재 막힌 지점과 재개 조건](docs/20260918_URDF_Isaac51_작업환경_프리뷰.md#순정-ggao-오른손-병-접촉-실험--2026-09-21)을 참고한다.
