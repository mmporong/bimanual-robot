...
<p align="center">
  <img src="assets/full_size_frame_20260910/product_concept_imagegen_v2.png" width="720" alt="450×340 mm 양팔 물 서빙 로봇 완성품 콘셉트">
</p>

위 그림은 외형과 배치 의도를 보여 주는 ImageGen 콘셉트다. 제조 치수나 시뮬레이션 검증 근거로
사용하지 않는다. 현재 생성된 URDF/STL의 축척과 좌표는
[구조 검증 렌더](assets/full_size_frame_20260910/model_overview.png)에서 별도로 확인한다.
